...
function() {
    ...
    var e = 180 / Math.PI,
        ...
        r = d3.dispatch("world"),
        c = -1;
    d3.selectAll("#map, #eisenlohr").data([n(a, o).scale(245).translate([a / 2, .56 * o]), d3.geo.eisenlohr().precision(.1).clipExtent([
            [-1, -1],
            [a + 1, o + 1]
        ]).translate([a / 2, o / 2]).scale(75).rotate([0, -30])]).append("svg").attr("width", a).attr("height", o).each(function(n) {
